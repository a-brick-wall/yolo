...
while True:
    ...
    if frame_count % detect_interval == 0 or bad_tracker:
        # Reset trackers
        trackers = []
        tracker_data = {}
        ...
        for i in range(len(detections)):
            ...
            if conf > 0.5:
                ...
                x1, y1, x2, y2 = xmin+1, ymin+1, xmax, ymax 
                w, h = x2-x1, y2-y1
                tracker=create_tracker()
                tracker.init(frame, (x1,y1,w,h))
                trackers.append((tracker, track_id))
                tracker_data[track_id]={'xmin':xmin,'ymin':ymin, 'xmax':xmax, 'ymax':ymax,'color':color}
        ...
        for tracker,track_id in trackers:
            ...
            if success:
                ...
                xmin, ymin, xmax, ymax, color = tracker_data[track_id]['xmin'],tracker_data[track_id]['ymin'],tracker_data[track_id]['xmax'],tracker_data[track_id]['ymax'],tracker_data[track_id]['color']
